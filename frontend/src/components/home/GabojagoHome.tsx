...
export default function GabojagoHome() {
    ...
    return (
        <div className="bg-white min-h-screen pb-24 font-sans antialiased">
            ...
            {/* Wayo Promotion Banner (Optional: Maybe remove from Gabojago specific page if not desired, but kept for now) */}
            <div className="mx-6 mt-12 mb-6">
                <div
                    onClick={() => router.push('/')} // Go to Wayo Home (which is now same URL but handled by domain, so maybe external link?)
