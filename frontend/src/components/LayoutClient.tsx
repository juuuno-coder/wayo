...
export default function LayoutClient({
  ...
  const isFullScreenPage = isAdminPage || isWayoLanding || isProfilePage || isLoginPage || isSignupPage || isLikesPage || isInvitationRoute || isFeaturesPage || isFaqPage || isSupportPage;
